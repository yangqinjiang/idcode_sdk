...
class HttpBaseTest extends \PHPUnit\Framework\TestCase
{
    public function testBase1(){
        ...
        //测试数据
        $hash = $data
            ->setUrl('https://apitest.idcode.org.cn')
            ->setPath('/abc/def')
        ...
        $this->assertEquals('https://apitest.idcode.org.cn/abc/def?access_token=J7X4LuOOfURXeAAEAAAAAABSK&id=123&name=zhangsan&time=1497587696789&hash=4E5B67B75447486AFC147BE5DEBF7758', $url);
    }
}
